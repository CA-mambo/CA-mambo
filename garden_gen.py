...
def generate_svg(weeks_data, username, is_mock=False):
    ...
    # 2. Draw Grid (V0.0.1 Logic + V1.0.0 Emojis)
    for week_index, week in enumerate(weeks_data):
        ...
        for day_index in range(7):
            ...
            # Draw Emoji directly
            svg_parts.append(f'<text x="{center_x}" y="{center_y}" text-anchor="middle" dominant-baseline="middle" font-size="{font_size}">{emoji}</text>')
