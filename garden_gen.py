...
def generate_svg(weeks_data, username, is_mock=False):
    ...
    <g>
        <!-- Mambo Character -->
        <image href="data:image/png;base64,{MAMBO_B64}" width="{mambo_size}" height="{mambo_size}" x="-20" y="{mambo_y}">
            <!-- Horizontal Patrol -->
            <animateMotion path="M 0,0 L {svg_width + 40},0" dur="40s" repeatCount="indefinite" />
